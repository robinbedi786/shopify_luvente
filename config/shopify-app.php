...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_themes,read_themes,write_themes,read_orders,write_orders,read_customers,write_customers'),
